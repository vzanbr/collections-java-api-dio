...
public class ExibirLivraria {
    public static void main(String[] args) {
        LivrariaOnline livrariaOnline = new LivrariaOnline();
        // Adiciona os livros à livraria online
        livrariaOnline.adicionarLivro("https://amzn.to/3EclT8Z", new Livro("1984", "Gabriel", 500d));
        ...
        livrariaOnline.adicionarLivro("https://amzn.to/45HQE1L", new Livro("E Não Sobrou Nenhum", "Agatha Christie", 550d));
        ...
        System.out.println("Livros ordenados por autor: \n" + livrariaOnline.pesquisarLivrosPorAutor("Gabriel"));
